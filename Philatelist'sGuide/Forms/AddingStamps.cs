...
namespace Довідник_філателіста
{
    public partial class AddingStamps : Form
    {
        ...
        {
            InitializeComponent();
            //Додаємо нову подію, яка буде відбуватися при закритті форми
        ...
        //Створюємо новий екземпляр класу Stamp
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (Check.Check_int(textBox3.Text) && 
                Convert.ToInt32(textBox3.Text) > 1600)
            {
            ...
            //
            if (Check.Check_int(textBox4.Text) 
                && Convert.ToInt32(textBox4.Text) > 0)
            {
            ...
            //
            if (Check.Check_double(textBox5.Text)
            ...
            {
                ListStamp.Add(new Stamp(ListStamp.MaxId + 1, 
                    country, year, circulation, cost, features));
        ...
        //Відкриваємо форму Список марок
